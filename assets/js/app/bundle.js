...
},{"./level":4,"./loggerManager":6}],3:[function(require,module,exports){
"use strict";
/**
...
},{"./display":2,"./level":4,"./logger":5,"./loggerManager":6}],4:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
/**
...
},{"./display":2,"./level":4}],6:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.ApplicationData = exports.Settings = exports.Theme = void 0;
...
var ApplicationData = (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 2:
                        _b.data = (_d.sent()) || this._settings.data;
                        _c = this;
                        return [4, this._storeSession.getItem(STORAGE_KEY_THEME)];
                    case 3:
                        _c._theme = (_d.sent()) || this._theme;
                        _d.label = 4;
                    case 4:
                        this._version = site_1.site.version;
    ...
    Object.defineProperty(ApplicationData.prototype, "theme", {
        get: function () {
            return this._theme;
        },
        set: function (value) {
...
},{"./observer":10,"./site":11,"localforage":1}],8:[function(require,module,exports){
"use strict";
var __awaiter = (this && this.__awaiter) || function (thisArg, _arguments, P, generator) {
    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }
    return new (P || (P = Promise))(function (resolve, reject) {
...
},{"./application.data":7,"typescript-logger":3}],9:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
require("./site");
...
},{"./application":8,"./site":11,"typescript-logger":3}],10:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"typescript-logger":3}],11:[function(require,module,exports){
'use strict';
...
var isOnScreen = function (element, factor_width, factor_height) {
    if (factor_width === void 0) { factor_width = 1.0; }
    if (factor_height === void 0) { factor_height = 1.0; }
    var win = $(window);
    var viewport = {
        top: win.scrollTop(),
        left: win.scrollLeft()
